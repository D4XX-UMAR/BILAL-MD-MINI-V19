...
CURRENT STATUS: ${userConfig.AUTO_VIEW_STATUS === 'true' ? 'ON' : 'OFF'}`);
}
...
if (!args[0]) {
return reply(`❤️ AUTO STATUS REACT

TYPE: .autolike on
TYPE: .autolike off

CURRENT STATUS: ${userConfig.AUTO_LIKE_STATUS === 'true' ? 'ON' : 'OFF'}`);
}

if (args[0] === "on") {

if (userConfig.AUTO_VIEW_STATUS !== "true") {
return reply("❌ PEHLE AUTO VIEW STATUS ON KRO\n\nTYPE: .autoview on");
}
...
return reply("✅ AUTO STATUS REACT ENABLED");
}
...
return reply("❌ AUTO STATUS REACT DISABLED");
}
